...
export default function WebsiteOverviewPage() {
  return (
    <div className="animate-fade-in-up pb-20">
      <h1 className="schibsted-grotesk-hero tracking-tight text-[var(--primary)]">Website Overview</h1>
      
      <p className="text-xl text-[var(--gray-900)] mt-4 mb-8">
      ...
      <div className="bg-[var(--background-200)] border border-[var(--gray-400)] p-6 rounded-[12px] my-10 not-prose">
        <h3 className="text-lg font-bold text-[var(--primary)] mb-2 flex items-center gap-2">
      ...
      <hr className="border-[var(--gray-400)] my-10" />

      <div className="flex justify-between items-center not-prose">
        <div></div>
        <Link 
          href="/docs/website/the-problem" 
          className="flex items-center gap-2 px-6 py-3 rounded-[6px] bg-[var(--background-100)] hover:bg-[var(--gray-100)] border border-[var(--gray-400)] transition-colors text-[var(--primary)] font-medium"
        >
