...
export default function WebsiteOverviewPage() {
  return (
    <div className="animate-fade-in-up pb-20">
      <h1 className="schibsted-grotesk-hero tracking-tight text-text-primary">Website Overview</h1>
      ...
      <div className="bg-white/5 border border-white/10 p-6 rounded-2xl my-10 not-prose">
      ...
      <div className="flex justify-between items-center not-prose">
        ...
        <Link 
          ...
          className="flex items-center gap-2 px-6 py-3 rounded-lg bg-white/5 hover:bg-white/10 border border-white/10 transition-colors text-text-primary font-medium"
        >
